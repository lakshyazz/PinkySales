...
<div class='p-6' x-data='exportTable'>
    <div class="panel mt-2">
        <div class='flex items-center justify-between mb-3'>
            <h1 class='text-primary text-2xl font-semibold'>Product Category</h1>

            <div class="flex flex-wrap items-center">
                <?php if(isset($_SESSION["type_admin"])){ ?> 
                    <button type="button" class="p-2 btn btn-primary btn-sm m-1" onclick="location.href='add_product_category.php'">
                        <i class="ri-add-line mr-1"></i> Add Product Category
                    </button>
                <?php }?>
        ...
        Alpine.data('exportTable', () => ({
            ...
            init() {
                ...
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    data: {
                        headings: ['Sr.No.', 'Product Category',
                        ...
                        data: [
                            ...
                            ?>
                                [
                                    ...
                                    <?php if(isset($_SESSION["type_admin"])){ ?> 
                                        getActions(<?php echo $row["id"]; ?>, '<?php echo $row["category_name"]; ?>')
                                    <?php }?>
                                ],
                            <?php
                                    $i++;
